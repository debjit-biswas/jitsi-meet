...
package com.softofficepro.connect;
...
public class MainActivity extends JitsiMeetActivity {
    ...
    protected boolean extraInitialize() {
        ...
        // Setup Crashlytics and Firebase Dynamic Connects
        // Here we are using reflection since it may have been disabled at compile time.
        try {
            Class<?> cls = Class.forName("com.softofficepro.connect.GoogleServicesHelper");
    ...
    protected void initialize() {
        ...
        JitsiMeetConferenceOptions defaultOptions
            = new JitsiMeetConferenceOptions.Builder()
                ...
                .setServerURL(buildURL("https://meet.softofficepro.com"))
